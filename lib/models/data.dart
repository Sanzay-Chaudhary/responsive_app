...
final User user_0 = User(
    name: const Name(first: 'Sanzay', last: ''),
    avatarUrl: 'assets/avatar_1.png',
    lastActive: DateTime.now());

final User user_1 = User(
    name: const Name(first: 'Kushal', last: 'Kafle'),
...
final User user_3 = User(
    name: const Name(first: 'Anish', last: 'Pandey'),
    avatarUrl: 'assets/avatar_4.png',
    lastActive: DateTime.now().subtract(const Duration(hours: 2)));

final User user_4 = User(
    name: const Name(first: 'Subin', last: 'adhikari'),
    avatarUrl: 'assets/avatar_1.png',
